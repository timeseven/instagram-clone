...
export const createMessage = createAsyncThunk("messages/create-a-message", async (data: ICreateMessage, thunkAPI) => {
  try {
...
export const getMessages = createAsyncThunk("messages/get-messages", async (id: string, thunkAPI) => {
  try {
...
export const deleteMessage = createAsyncThunk("messages/delete-a-message", async (id: string, thunkAPI) => {
  try {
...
export const messagesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createMessage.fulfilled, (state, action: PayloadAction<IMessage>) => {
        state.isError = false;
        state.isLoading = false;
        state.isSuccess = true;
        state.mData.unshift(action.payload);
      ...
      .addCase(getMessages.fulfilled, (state, action: PayloadAction<Array<IMessage>>) => {
        state.isError = false;
        state.isLoading = false;
        state.isSuccess = true;
      ...
      .addCase(deleteMessage.fulfilled, (state, action: PayloadAction<IMessage>) => {
        ...
        state.isLoading = false;
        state.isSuccess = true;
        state.mData = state.mData.filter((obj) => obj._id !== action.payload._id);
        state.message = "success";
      })
      ...
      .addCase(setCreateMessageSocket.fulfilled, (state, action: PayloadAction<IMessage>) => {
        state.isError = false;
        state.isLoading = false;
        state.isSuccess = true;
      ...
      .addCase(setDeleteMessageSocket.fulfilled, (state, action: PayloadAction<IMessage>) => {
        state.isError = false;
        state.isLoading = false;
        state.isSuccess = true;
      ...
      .addCase(setDeleteConversationMessageSocket.fulfilled, (state, action: PayloadAction<string>) => {
        state.isError = false;
        state.isLoading = false;
        state.isSuccess = true;

        state.mData = state.mData!.filter((obj) => obj.conversation !== action.payload);
