  ...
  return (
    <Helmet title="Forgot Password • Instagram">
      ...
      <div className="pt-40 flex items-center justify-center mb-20">
        <form className="max-w-[24.25rem] min-w-[15rem] py-0 px-12 border border-solid border-neutral-300 rounded-md flex flex-col items-center justify-center">
          ...
          <button
            type="submit"
            className="w-full h-8 mt-4 mb-4 mx-0 bg-sky-500 text-sm font-semibold text-white border border-none rounded-lg"
            // className={isActive ? "" : ""}
